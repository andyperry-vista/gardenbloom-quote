...
Deno.serve(async (req) => {
  ...
  // verify_jwt=true at the gateway ensures the JWT signature is valid.
  // We additionally verify the role claim cryptographically via getClaims()
  // (no trust in unsigned base64 decoding).
